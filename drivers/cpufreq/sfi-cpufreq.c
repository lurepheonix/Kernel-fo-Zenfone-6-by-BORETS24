...
#ifdef CPU_ATOM_UNDERCLOCK
	sfi_cpufreq_num = sfi_cpufreq_num - 8; //need to remove the 2 UC states temporarily
#endif
...
#ifdef CPU_ATOM_UNDERCLOCK
	sfi_cpufreq_num = sfi_cpufreq_num + 8; //and now add them back again for cosmetic purposes to make the code more understandable
...
//+State [24]: core_frequency[333] transition_latency[100] control[0x42e] -83MHz	100	0x101
	pr->performance->states[sfi_cpufreq_num-8].core_frequency = sfi_cpufreq_array[last_PState].freq_mhz - 84; //716
	pr->performance->states[sfi_cpufreq_num-8].transition_latency = sfi_cpufreq_array[last_PState].latency;
	pr->performance->states[sfi_cpufreq_num-8].control = sfi_cpufreq_array[last_PState].ctrl_val - 0x101;
	pr->performance->states[sfi_cpufreq_num-7].core_frequency = sfi_cpufreq_array[last_PState].freq_mhz - 84 - 83; //633
	pr->performance->states[sfi_cpufreq_num-7].transition_latency = sfi_cpufreq_array[last_PState].latency;
	pr->performance->states[sfi_cpufreq_num-7].control = sfi_cpufreq_array[last_PState].ctrl_val - 0x101 - 0x101;
	pr->performance->states[sfi_cpufreq_num-6].core_frequency = sfi_cpufreq_array[last_PState].freq_mhz - 84 - 83 - 83; //550
	pr->performance->states[sfi_cpufreq_num-6].transition_latency = sfi_cpufreq_array[last_PState].latency;
	pr->performance->states[sfi_cpufreq_num-6].control = sfi_cpufreq_array[last_PState].ctrl_val - 0x101 - 0x101 - 0x101;
	pr->performance->states[sfi_cpufreq_num-5].core_frequency = sfi_cpufreq_array[last_PState].freq_mhz - 84 - 83 - 83 - 84; //466
	pr->performance->states[sfi_cpufreq_num-5].transition_latency = sfi_cpufreq_array[last_PState].latency;
	pr->performance->states[sfi_cpufreq_num-5].control = sfi_cpufreq_array[last_PState].ctrl_val - 0x101 - 0x101 - 0x101 - 0x101;
	pr->performance->states[sfi_cpufreq_num-4].core_frequency = sfi_cpufreq_array[last_PState].freq_mhz - 84 - 83 - 83 - 84 - 83; //383
	pr->performance->states[sfi_cpufreq_num-4].transition_latency = sfi_cpufreq_array[last_PState].latency;
	pr->performance->states[sfi_cpufreq_num-4].control = sfi_cpufreq_array[last_PState].ctrl_val - 0x101 - 0x101 - 0x101 - 0x101 - 0x101;
	pr->performance->states[sfi_cpufreq_num-3].core_frequency = sfi_cpufreq_array[last_PState].freq_mhz - 84 - 83 - 83 - 84 - 83 - 83; //300
	pr->performance->states[sfi_cpufreq_num-3].transition_latency = sfi_cpufreq_array[last_PState].latency;
	pr->performance->states[sfi_cpufreq_num-3].control = sfi_cpufreq_array[last_PState].ctrl_val - 0x101 - 0x101 - 0x101 - 0x101 - 0x101 - 0x101;
	pr->performance->states[sfi_cpufreq_num-2].core_frequency = sfi_cpufreq_array[last_PState].freq_mhz - 84 - 83 - 83 - 84 - 83 - 83 - 84; //214
	pr->performance->states[sfi_cpufreq_num-2].transition_latency = sfi_cpufreq_array[last_PState].latency;
	pr->performance->states[sfi_cpufreq_num-2].control = sfi_cpufreq_array[last_PState].ctrl_val - 0x101 - 0x101 - 0x101 - 0x101 - 0x101 - 0x101 - 0x101;
	pr->performance->states[sfi_cpufreq_num-1].core_frequency = sfi_cpufreq_array[last_PState].freq_mhz - 84 - 83 - 83 - 84 - 83 - 83 - 84 - 83; //131(?)
	pr->performance->states[sfi_cpufreq_num-1].transition_latency = sfi_cpufreq_array[last_PState].latency;
	pr->performance->states[sfi_cpufreq_num-1].control = sfi_cpufreq_array[last_PState].ctrl_val - 0x101 - 0x101 - 0x101 - 0x101 - 0x101 - 0x101 - 0x101 - 0x101;
	
	for(i = sfi_cpufreq_num - 8; i<sfi_cpufreq_num; i++)
	{
